...
\newcommand{\Tit}{SimMult}
\newcommand{\Version}{Version 2.7}
\newcommand{\Dates}{February 2026}
\newcommand{\Where}{SDCC}
\newcommand{\Homepage}{\url{https://BendixCarstensen.com/Epi/04simLexis.pdf}}
...
[1] survival_3.8-6 popEpi_0.4.14  Epi_2.64      

loaded via a namespace (and not attached):
 [1] etm_1.1.2           vctrs_0.7.2         nlme_3.1-168        cli_3.6.5          
 [5] rlang_1.1.7         cmprsk_2.2-12       generics_0.1.4      data.table_1.18.2.1
 [9] zoo_1.8-15          glue_1.8.0          plyr_1.8.9          grid_4.5.3         
[13] tibble_3.3.1        MASS_7.3-65         numDeriv_2016.8-1.1 lifecycle_1.0.5    
[17] compiler_4.5.3      dplyr_1.2.0         Rcpp_1.1.1          pkgconfig_2.0.3    
[21] mgcv_1.9-4          lattice_0.22-9      R6_2.6.1            tidyselect_1.2.1   
[25] pillar_1.11.1       parallel_4.5.3      splines_4.5.3       magrittr_2.0.4     
[29] Matrix_1.7-4        tools_4.5.3        
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
 lex.id     Per   Age DMdur t.Ins lex.dur lex.Cst   lex.Xst sex   dobth
     97 1997.55 58.93  0.00    NA    0.25      DM        DM   F 1938.62
     97 1997.80 59.18  0.25    NA    0.25      DM        DM   F 1938.62
     97 1998.05 59.43  0.50    NA    0.25      DM        DM   F 1938.62
     97 1998.30 59.68  0.75    NA    0.25      DM        DM   F 1938.62
     97 1998.55 59.93  1.00    NA    0.25      DM        DM   F 1938.62
     97 1998.80 60.18  1.25    NA    0.25      DM        DM   F 1938.62
     97 1999.05 60.43  1.50    NA    0.25      DM        DM   F 1938.62
     97 1999.30 60.68  1.75    NA    0.25      DM        DM   F 1938.62
     97 1999.55 60.93  2.00    NA    0.18      DM       Ins   F 1938.62
     97 1999.72 61.11  2.18  0.00    0.07     Ins       Ins   F 1938.62
     97 1999.80 61.18  2.25  0.07    0.25     Ins       Ins   F 1938.62
     97 2000.05 61.43  2.50  0.32    0.25     Ins       Ins   F 1938.62
     97 2000.30 61.68  2.75  0.57    0.25     Ins       Ins   F 1938.62
     97 2000.55 61.93  3.00  0.82    0.01     Ins Dead(Ins)   F 1938.62
\end{Soutput}
\end{Schunk}
...
If we want to see how the mortality rates are modeled in
...
4 states, so that we can assess the fraction of diabetes patients that
go on insulin
...
Classes 'Lexis' and 'data.frame':	0 obs. of  9 variables:
 ...
 - attr(*, "time.scales")= chr [1:4] "Per" "Age" "DMdur" "t.Ins"
 - attr(*, "time.since")= chr [1:4] "" "" "" "Ins"
 - attr(*, "breaks")=List of 4
  ..$ Per  : NULL
  ..$ Age  : NULL
  ..$ DMdur: num [1:81] 0 0.25 0.5 0.75 1 1.25 1.5 1.75 2 2.25 ...
  ..$ t.Ins: NULL
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
 lex.id  Per Age DMdur t.Ins lex.dur lex.Cst lex.Xst sex
      1 1995  60     5    NA      NA      DM    <NA>   M
      2 1995  60     5    NA      NA      DM    <NA>   F
\end{Soutput}
\end{Schunk}
...
a timescale that first comes alive if a transition to \texttt{Ins} is
simulated.
...
the simulated follow-up of 1000 persons (500
identical men and 500 identical women) according to the rates
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  148 185  167         0       500      352    3697.59       500
  Ins   0 136    0        49       185       49    1023.96       185
  Sum 148 321  167        49       685      401    4721.55       500
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  214 183  103         0       500      286    4223.33       500
  Ins   0 144    0        39       183       39    1020.36       183
  Sum 214 327  103        39       683      325    5243.69       500
\end{Soutput}
\end{Schunk}
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  148 222  130         0       500      352    3703.19       500
  Ins   0 127    0        95       222       95    1049.95       222
  Sum 148 349  130        95       722      447    4753.14       500
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  224 171  105         0       500      276    4323.34       500
  Ins   0 118    0        53       171       53     861.93       171
  Sum 224 289  105        53       671      329    5185.27       500
\end{Soutput}
\end{Schunk}
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  171 192  137         0       500      329    3645.74       500
  Ins   0 123    0        69       192       69    1007.35       192
  Sum 171 315  137        69       692      398    4653.09       500
...
Transitions:
     To
From   DM Ins Dead Dead(Ins)  Records:  Events: Risk time:  Persons:
  DM  227 185   88         0       500      273    4332.82       500
  Ins   0 138    0        47       185       47     821.79       185
  Sum 227 323   88        47       685      320    5154.61       500
\end{Soutput}
\end{Schunk}
...
when        DM   Ins Dead(Ins) Dead
  ...
  1995.2 0.994 0.998     0.998    1
  1995.4 0.972 0.988     0.988    1
  1995.6 0.954 0.980     0.980    1
  1995.8 0.936 0.968     0.968    1
  1996   0.918 0.958     0.958    1
\end{Soutput}
\begin{Sinput}
...
\item Type of transition:
  ...
  \item In the second approach we choose the transition corresponding
    ...
    that events of type $1,2,3$ takes place in the interval
    $(t,t+\dif t)$ are $\lambda_1(t)\dif t$, $\lambda_2(t)\dif t$ and
    $\lambda_3(t)\dif t$, respectively (assuming that the probability
    of more than one event in the interval of length $\dif t$ is
    0). Hence the conditional probability of transition of type $i$
    \emph{given a transition time} in $(t,t+\dif t)$ is:
    \[
...
\begin{Schunk}
\begin{Soutput}
  Start time: 2026-04-13, 14:02:13 
    End time: 2026-04-13, 14:02:36 
