%\VignetteIndexEntry{Analysis of follow-up data using the Lexis functions in Epi}
...
\begin{Schunk}
\begin{Soutput}
Start time: 2024-05-27, 17:06:20 
\end{Soutput}
\end{Schunk}
...
loaded via a namespace (and not attached):
 [1] etm_1.1.1           vctrs_0.6.5         nlme_3.1-164        cli_3.6.2          
 [5] rlang_1.1.3         cmprsk_2.2-12       generics_0.1.3      data.table_1.15.4  
 [9] zoo_1.8-12          glue_1.7.0          plyr_1.8.9          fansi_1.0.6        
[13] grid_4.4.0          tibble_3.2.1        MASS_7.3-60.2       numDeriv_2016.8-1.1
[17] lifecycle_1.0.4     compiler_4.4.0      dplyr_1.1.4         Rcpp_1.0.12        
[21] pkgconfig_2.0.3     mgcv_1.9-1          lattice_0.22-6      R6_2.5.1           
[25] tidyselect_1.2.1    utf8_1.2.4          pillar_1.9.0        parallel_4.4.0     
[29] splines_4.4.0       magrittr_2.0.3      Matrix_1.7-0        survival_3.5-8     
\end{Soutput}
\end{Schunk}
...
follow-up, but the results are not necessarily identical on all machines:
\begin{Schunk}
\begin{Sinput}
> if (require(popEpi, quietly = TRUE)) 
+    {
...
$formula
~Ns(age, knots = a.kn)
<environment: 0x000001b884d684d8>
...
From        DM Dead  OAD  Ins OAD-Ins Ins-OAD  Records:  Events: Risk time:  Persons:
  DM      2830 1056 2957  689       0       0      7532     4702   22920.12      7532
  OAD        0  992 3327    0    1005       0      5324     1997   22965.28      5324
  Ins        0  152    0  462       0     172       786      324    3883.12       786
  OAD-Ins    0  266    0    0     739       0      1005      266    3770.59      1005
  Ins-OAD    0   33    0    0       0     139       172       33     734.16       172
...
\begin{Soutput}
 lex.id     per   age  tfD  tfI  tfO lex.dur lex.Cst lex.Xst sex    dobth     dodm
     ...
     20 2009.27 53.24 0.03 0.00   NA    0.01     Ins Ins-OAD   F 1956.029 2009.247
     20 2009.28 53.25 0.03 0.01 0.00    0.72 Ins-OAD Ins-OAD   F 1956.029 2009.247
...
From        DM Dead  OAD  Ins OAD+Ins  Records:  Events: Risk time:  Persons:
  DM      2830 1056 2957  689       0      7532     4702   22920.12      7532
  OAD        0  992 3327    0    1005      5324     1997   22965.28      5324
  Ins        0  152    0  462     172       786      324    3883.12       786
  OAD+Ins    0  299    0    0     878      1177      299    4504.75      1177
