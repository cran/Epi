...
\newcommand{\Version}{Version 12}
\newcommand{\Dates}{February 2025}
...
This vignette is an introduction to the \texttt{Lexis} machinery in
the \texttt{Epi} package, intended for representation and manipulation
of follow-up data (``event history data'') from studies where exact
dates of events (state transitions) are known. It accommodates
follow-up through multiple states and on multiple time scales.
...
of transition rates is based on a \texttt{Lexis} representation with
very small follow-up intervals.
...
\begin{itemize}[noitemsep]
  ...
  \item Time at treatment---\emph{at} treatment, time since treatment
    is 0, but persons may enter before or after treatment beginning.
...
To limit the size of the graphs we only use a 5\% sample of the
persons:
\begin{Schunk}
\begin{Sinput}
> set.seed(1952)
...
Transitions:
     To
From  DM Dead  Records:  Events: Risk time:  Persons:
  DM 386  113       499      113       2530       499
\end{Soutput}
\begin{Sinput}
> plot(dmS)
\end{Sinput}
\end{Schunk}
The function \texttt{plot.Lexis} allows quite a bit of control over
the output, and a \texttt{points.Lexis} function allows plotting of
the endpoints of follow-up:
\begin{Schunk}
\begin{Sinput}
...
convention in \R\ that the index is taken as \emph{number of the
  ...
  "red")[dmS\$sex]} is \texttt{"blue"} when \texttt{sex} is \texttt{M}
...
clipping behavior is not available in \texttt{splitLexis},
...
$formula
~Ns(age, knots = a.kn)
<environment: 0x000001e8e612c390>
...
From        DM  OAD  Ins OAD-Ins Ins-OAD Dead  Records:  Events: Risk time:  Persons:
  DM      2830 2958  688       0       0 1056      7532     4702   22920.24      7532
  OAD        0 3327    0    1006       0  992      5325     1998   22965.23      5325
  Ins        0    0  462       0     171  152       785      323    3883.06       785
  OAD-Ins    0    0    0     741       0  265      1006      265    3789.48      1006
  Ins-OAD    0    0    0       0     137   34       171       34     715.26       171
...
\begin{Soutput}
 lex.id     per   age  tfD  tfI  tfO lex.dur lex.Cst lex.Xst sex   dobth    dodm dodth
     ...
     20 2009.28 53.25 0.03   NA 0.00    0.00     OAD OAD-Ins   F 1956.03 2009.25    NA
     20 2009.28 53.25 0.03 0.00 0.00    0.72 OAD-Ins OAD-Ins   F 1956.03 2009.25    NA
...
From        DM  OAD  Ins OAD+Ins Dead  Records:  Events: Risk time:  Persons:
  DM      2830 2958  688       0 1056      7532     4702   22920.24      7532
  OAD        0 3327    0    1006  992      5325     1998   22965.23      5325
  Ins        0    0  462     171  152       785      323    3883.06       785
  OAD+Ins    0    0    0     878  299      1177      299    4504.74      1177
...
Transitions:
     To
From         DM   OAD  Ins OAD+Ins Dead  Records:  Events: Risk time:  Persons:
  DM      25682  2958  688       0 1055     30383     4701   22920.21      7532
  OAD         0 26226    0    1006  990     28222     1996   22959.10      5324
  Ins         0     0 4353     171  152      4676      323    3883.06       785
  OAD+Ins     0     0    0    5357  298      5655      298    4503.77      1177
...
\begin{Soutput}
           exp(Est.)     2.5%    97.5%
lex.CstOAD  1.867488 1.682886 2.072339
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
           exp(Est.)      2.5%     97.5%
lex.CstIns 0.4965073 0.4237295 0.5817852
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
               exp(Est.)      2.5%    97.5%
lex.CstOAD     0.9461356 0.8675587 1.031829
lex.CstIns     2.6396301 2.2221467 3.135548
lex.CstOAD+Ins 1.6368383 1.4394442 1.861302
\end{Soutput}
\end{Schunk}
...
\item[\texttt{xcutLexis}] cut follow-up at another set of events,
  keeping the orignal states (cross classification)
\item[\texttt{countLexis}] cut follow-up at intermediate event time
  and coun  the no. events so far
...
\item[\texttt{paths.Lexis}] what are the paths through states for persons in a \texttt{Lexis} object
...
\item[\texttt{lexVars}] names of the \texttt{Lexis} specific variables
...
\begin{Schunk}
\begin{Soutput}
  Start time: 2026-04-13, 13:58:51 
    End time: 2026-04-13, 13:59:28 
