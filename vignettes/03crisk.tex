...
\newcommand{\Homepage}{\url{https://bendixcarstensen.com/Epi/}}
...
Bendix Carstensen
  ...
  & \url{https://BendixCarstensen.com/} \\[1em]
                      \end{tabular}}
...
kind, and they are not necessarily in $[0,1]$.
...
dates of \texttt{OAD} and \texttt{Ins} using \texttt{mcutLexis}, for
convenience we restrict to a 10\% sample of the dataset:
\begin{Schunk}
\begin{Sinput}
> data(DMlate)
> set.seed(1952)
...
From  DM Dead  Records:  Events: Risk time:  Persons:
  DM 769  266      1035      266    5620.72      1035
...
NOTE: 1 records with tied events times resolved (adding 0.01 random uniform),
...
Transitions:
     To
From       DM OAD Dead Ins+OAD Ins  Records:  Events: Risk time:  Persons:
  DM      291 294  109       0  67       761      470    2349.27       761
  OAD       0 354  104      99   0       557      203    2449.93       557
  Ins+OAD   0   0   34      81   0       115       34     457.69       115
  Ins       0   0   19      16  43        78       35     363.83        78
  Sum     291 648  266     196 110      1511      742    5620.72      1035
\end{Soutput}
\end{Schunk}
...
Transitions:
     To
From    DM OAD Dead Ins  Records:  Events: Risk time:  Persons:
  DM 28126 294  109  67     28596      470    2349.27       761
\end{Soutput}
\end{Schunk}
...
1st Qu. 1.0000291552490483404
Median  1.0000292475957022198
Mean    1.0000286004322973543
3rd Qu. 1.0000294926075912194
Max.    1.0000296081898985001
\end{Soutput}
\begin{Sinput}
> options(oo)
\end{Sinput}
...
\begin{Soutput}
       sjA        sjD        sjI        sjO            
 4.4123494  1.2820889  0.8056056  3.5502436 10.0502874 
\end{Soutput}
\end{Schunk}
...
0    0.3385147 0.2494032 0.4594656 0.3385147 0.2494032 0.4594656
0.05 0.2825126 0.2132543 0.3742639 0.2825126 0.2132543 0.3742639
0.1  0.2357793 0.1814081 0.3064466 0.2357793 0.1814081 0.3064466
0.15 0.1967848 0.1533463 0.2525283 0.1967848 0.1533463 0.2525283
0.2  0.1642517 0.1286861 0.2096467 0.1642517 0.1286861 0.2096467
0.25 0.1371131 0.1071636 0.1754327 0.1371131 0.1071636 0.1754327
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:4] -1.02 -1.23 -1.44 -1.64 -1.85 ...
...
\begin{Soutput}
      Estimate      2.5%     97.5%                                        
0    0.3385147 0.2494032 0.4594656 0.4026718 0.3677533 0.2908211 0.3435861
0.05 0.2825126 0.2132543 0.3742639 0.3230181 0.3050807 0.2485039 0.2775458
0.1  0.2357793 0.1814081 0.3064466 0.2591266 0.2530927 0.2123476 0.2242037
0.15 0.1967848 0.1533463 0.2525283 0.2078832 0.2099717 0.1814584 0.1811220
0.2  0.1642517 0.1286861 0.2096467 0.1667888 0.1742091 0.1550726 0.1463312
0.25 0.1371131 0.1071636 0.1754327 0.1338375 0.1445528 0.1325372 0.1182392
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
List of 4
 $ Crisk: num [1:201, 1:4, 1:3] 1 0.957 0.919 0.885 0.856 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:4] "Surv" "OAD" "Ins" "Dead"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
 $ Srisk: num [1:201, 1:3, 1:3] 0 0.00464 0.00898 0.01306 0.01687 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:3] "Dead" "Dead+Ins" "Dead+Ins+OAD"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
 $ Stime: num [1:201, 1:4, 1:3] 0 0.0489 0.0958 0.1409 0.1844 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:4] "Surv" "OAD" "Ins" "Dead"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:3, 1:500] 0.408 0.391 0.374 0.358 0.342 ...
 - attr(*, "dimnames")=List of 3
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:4, 1:500] 1 0.961 0.926 0.894 0.866 ...
 - attr(*, "dimnames")=List of 3
  ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  ..$ cause: chr [1:4] "Surv" "OAD" "Ins" "Dead"
  ..$ sim  : chr [1:500] "1" "2" "3" "4" ...
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:3, 1:3] 0.487 0.461 0.438 0.415 0.393 ...
 - attr(*, "dimnames")=List of 3
  ..$ time: chr [1:201] "0" "0.05" "0.1" "0.15" ...
  ..$ mod : chr [1:3] "OAD" "Ins" "Dead"
  ..$     : chr [1:3] "50%" "2.5%" "97.5%"
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:4, 1:3] 1 0.957 0.919 0.885 0.856 ...
 - attr(*, "dimnames")=List of 3
  ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  ..$ cause: chr [1:4] "Surv" "OAD" "Ins" "Dead"
  ..$      : chr [1:3] "50%" "2.5%" "97.5%"
...
\end{Sinput}
\begin{Soutput}
 num [1:201, 1:3, 1:3] 0 0.00464 0.00898 0.01306 0.01687 ...
 - attr(*, "dimnames")=List of 3
  ..$ tfd  : chr [1:201] "0" "0.05" "0.1" "0.15" ...
  ..$ cause: chr [1:3] "Dead" "Dead+Ins" "Dead+Ins+OAD"
  ..$      : chr [1:3] "50%" "2.5%" "97.5%"
...
\begin{Soutput}
              50% 2.5% 97.5%
tfd   cause                 
 5 yr Surv   2.72 2.56  2.88
      OAD    1.44 1.29  1.60
      Ins    0.38 0.30  0.48
      Dead   0.44 0.36  0.56
10 yr Surv   4.34 3.99  4.66
      OAD    3.54 3.22  3.87
      Ins    0.83 0.65  1.05
      Dead   1.28 1.06  1.56
\end{Soutput}
...
\end{Soutput}
\end{Schunk}
The code to fit the \texttt{gam} modes is (not run):
\ldots and the code to fit \texttt{glm}s with splines is:
\begin{Schunk}
\begin{Sinput}
...
\begin{Soutput}
List of 4
 $ Crisk: num [1:301, 1:4, 1:3] 1 0.997 0.994 0.991 0.988 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfD  : chr [1:301] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:4] "Surv" "CVD" "Can" "Other"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
 $ Srisk: num [1:301, 1:3, 1:3] 0 0.00163 0.00323 0.00482 0.00638 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfD  : chr [1:301] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:3] "Other" "Other+Can" "Other+Can+CVD"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
 $ Stime: num [1:301, 1:4, 1:3] 0 0.0499 0.0997 0.1493 0.1988 ...
  ..- attr(*, "dimnames")=List of 3
  .. ..$ tfD  : chr [1:301] "0" "0.05" "0.1" "0.15" ...
  .. ..$ cause: chr [1:4] "Surv" "CVD" "Can" "Other"
  .. ..$      : chr [1:3] "50%" "2.5%" "97.5%"
...
6          5.2  5.2   5.3  0.2  0.2   0.3  0.1  0.1   0.1   0.4  0.4   0.4
9          7.4  7.3   7.4  0.5  0.5   0.6  0.3  0.2   0.3   0.8  0.8   0.9
12         9.2  9.1   9.3  0.9  0.8   1.0  0.4  0.4   0.5   1.4  1.3   1.5
15        10.7 10.5  10.9  1.4  1.3   1.5  0.7  0.6   0.8   2.2  2.0   2.3
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
 num [1:301, 1:4, 1:500] 1 0.998 0.995 0.993 0.99 ...
 - attr(*, "dimnames")=List of 3
  ..$ tfD  : chr [1:301] "0" "0.05" "0.1" "0.15" ...
  ..$ cause: chr [1:4] "Surv" "CVD" "Can" "Other"
  ..$ sim  : chr [1:500] "1" "2" "3" "4" ...
...
\end{Sinput}
\begin{Soutput}
 num [1:3, 1:301] 0 0 0 -0.0424 -0.089 ...
 - attr(*, "dimnames")=List of 2
  ..$    : chr [1:3] "50%" "2.5%" "97.5%"
  ..$ tfD: chr [1:301] "0" "0.05" "0.1" "0.15" ...
\end{Soutput}
...
\begin{Schunk}
\begin{Soutput}
  Start time: 2026-04-13, 17:12:02 
    End time: 2026-04-13, 17:12:27 
