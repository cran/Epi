...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{n05-yll-imm}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{n05-yll-sus}
  \caption{Years of life lost to DM: the difference in expected
    residual life time at different ages between persons with and
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{n05-yll-tot}
  \caption{Years of life lost to DM: the difference in expected
    residual life time at different ages between persons with and
