...
for( aa in 4:7*10 ) for( ii in 1:4 )
   matlines( aa+as.numeric(dimnames(pr.rates)[[1]]),
            ...
            col=rep(c("red","forestgreen"),each=3) )
...
###################################################
### code chunk number 27: sim-Lexis.rnw:925-926
###################################################
options( keep.source=TRUE )


###################################################
### code chunk number 28: sim-Lexis.rnw:942-945
###################################################
cbind(
attr( ini, "time.scale" ),
attr( ini, "time.since" ) )
...
###################################################
### code chunk number 29: sim-Lexis.rnw:970-971
###################################################
simLexis


###################################################
### code chunk number 30: sim-Lexis.rnw:988-989
###################################################
Epi:::simX


###################################################
### code chunk number 31: sim-Lexis.rnw:1001-1002
###################################################
Epi:::sim1


###################################################
### code chunk number 32: sim-Lexis.rnw:1013-1014
###################################################
Epi:::lint


###################################################
### code chunk number 33: sim-Lexis.rnw:1024-1025
###################################################
Epi:::get.next


###################################################
### code chunk number 34: sim-Lexis.rnw:1034-1035
###################################################
Epi:::chop.lex


###################################################
### code chunk number 35: sim-Lexis.rnw:1052-1053
###################################################
nState


###################################################
### code chunk number 36: sim-Lexis.rnw:1062-1063
###################################################
pState


###################################################
### code chunk number 37: sim-Lexis.rnw:1067-1069
###################################################
plot.pState
lines.pState
