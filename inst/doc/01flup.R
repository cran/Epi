...
###################################################
### code chunk number 9: 01flup.rnw:332-335
###################################################
...
###################################################
### code chunk number 10: 01flup.rnw:345-348
###################################################
wh.id <- c(9, 27, 52, 484)
...
###################################################
### code chunk number 11: 01flup.rnw:356-358
###################################################
...
###################################################
### code chunk number 12: 01flup.rnw:363-369
###################################################
dmM <- splitMulti(dmL,
                  age = seq(0, 100, 5),
...
###################################################
### code chunk number 13: 01flup.rnw:401-408
###################################################
...
###################################################
### code chunk number 14: 01flup.rnw:423-429
###################################################
...
###################################################
### code chunk number 15: 01flup.rnw:447-448
###################################################
...
###################################################
### code chunk number 17: 01flup.rnw:493-501
###################################################
...
###################################################
### code chunk number 18: 01flup.rnw:532-533
###################################################
summary((dmS2$age - dmS2$tfD) - (dmS2$dodm - dmS2$dobth))


###################################################
### code chunk number 19: 01flup.rnw:539-542
###################################################
...
###################################################
### code chunk number 20: 01flup.rnw:651-653
###################################################
...
###################################################
### code chunk number 21: 01flup.rnw:675-680
###################################################
...
###################################################
### code chunk number 22: 01flup.rnw:696-701
###################################################
...
###################################################
### code chunk number 23: 01flup.rnw:720-724
###################################################
...
###################################################
### code chunk number 24: 01flup.rnw:730-732
###################################################
...
###################################################
### code chunk number 25: 01flup.rnw:737-738
###################################################
attr(Xa, "Lexis")


###################################################
### code chunk number 26: 01flup.rnw:749-752
###################################################
transient(dmCs)
absorbing(dmCs)
...
###################################################
### code chunk number 27: 01flup.rnw:756-757
###################################################
xa <- glmLexis(dmCs, formula = ~ Ns(age, knots = a.kn))


###################################################
### code chunk number 28: 01flup.rnw:760-764
###################################################
c(ma = deviance(ma),
  Ma = deviance(Ma),
  Xa = deviance(Xa),
...
###################################################
### code chunk number 30: 01flup.rnw:811-816
###################################################
...
###################################################
### code chunk number 31: 01flup.rnw:819-821
###################################################
...
###################################################
### code chunk number 32: 01flup.rnw:838-843
###################################################
pm <- glm(cbind(lex.Xst == "Dead", lex.dur) ~ Ns(age, knots = a.kn)
                                            + Ns(tfI, knots = i.kn)
                                            + lex.Cst + sex,
...
###################################################
### code chunk number 33: 01flup.rnw:849-855
###################################################
...
###################################################
### code chunk number 34: 01flup.rnw:861-862
###################################################
...
###################################################
### code chunk number 36: 01flup.rnw:931-934
###################################################
...
###################################################
### code chunk number 37: 01flup.rnw:938-941
###################################################
...
###################################################
### code chunk number 38: 01flup.rnw:958-961
###################################################
...
###################################################
### code chunk number 41: 01flup.rnw:1083-1088
###################################################
...
###################################################
### code chunk number 42: 01flup.rnw:1097-1103
###################################################
...
###################################################
### code chunk number 43: 01flup.rnw:1112-1113
###################################################
...
###################################################
### code chunk number 46: 01flup.rnw:1158-1171
###################################################
dmd <- glmLexis(dmCs,
                 from = "DM", to = "Dead",
                 formula = ~ Ns(age, knots = a.kn)
...
###################################################
### code chunk number 49: 01flup.rnw:1220-1227
###################################################
...
###################################################
### code chunk number 51: 01flup.rnw:1259-1265
###################################################
dmM <- mcutLexis(dmL,
           timescale = "per",
                  wh = c("doins", "dooad"),
...
###################################################
### code chunk number 52: 01flup.rnw:1269-1272
###################################################
levels(dmM)
...
###################################################
### code chunk number 53: 01flup.rnw:1276-1279
###################################################
...
###################################################
### code chunk number 56: 01flup.rnw:1331-1340
###################################################
...
###################################################
### code chunk number 57: 01flup.rnw:1505-1509
###################################################
ende <- Sys.time()
cat("  Start time:", format(anfang, "%F, %T"),
