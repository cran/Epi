...
###################################################
### code chunk number 1: Follow-up.rnw:65-66
###################################################
library(Epi)


###################################################
### code chunk number 2: Follow-up.rnw:143-150
###################################################
data( nickel ) 
...
###################################################
### code chunk number 3: Follow-up.rnw:160-163
###################################################
str( nickel )
str( nicL )
head( nicL )
...
###################################################
### code chunk number 4: Follow-up.rnw:172-173
###################################################
summary( nicL )
...
###################################################
### code chunk number 7: Follow-up.rnw:226-229
###################################################
...
###################################################
### code chunk number 8: Follow-up.rnw:236-237
###################################################
round( subset( nicS1, id %in% 8:10 ), 2 )


###################################################
### code chunk number 9: Follow-up.rnw:242-244
###################################################
...
###################################################
### code chunk number 10: Follow-up.rnw:250-255
###################################################
...
###################################################
### code chunk number 11: Follow-up.rnw:273-278
###################################################
...
###################################################
### code chunk number 12: Follow-up.rnw:284-289
###################################################
...
###################################################
### code chunk number 13: Follow-up.rnw:309-318
###################################################
data( nickel ) 
nicL <- Lexis( entry = list( per=agein+dob,
                             age=agein, 
...
###################################################
### code chunk number 14: Follow-up.rnw:322-330
###################################################
nicL <- Lexis( entry = list( per=agein+dob,
                             age=agein,
                             tfh=agein-age1st ),
...
###################################################
### code chunk number 15: Follow-up.rnw:342-350
###################################################
...
###################################################
### code chunk number 16: Follow-up.rnw:368-376
###################################################
nicC <- cutLexis( data = nicL, 
                   cut = nicL$agehi, 
             timescale = "age", 
